FROM melkortf/tf2-competitive:1.2.1
...
RUN wget "https://forums.alliedmods.net/attachment.php?attachmentid=188744&d=1618607414" -O system2.zip \
  ...
  && rm -f steamworks.tgz \
  && wget "https://github.com/tf2pickup-org/connector/releases/download/0.2.0/connector.smx" -O $SERVER_DIR/tf/addons/sourcemod/plugins/connector.smx \
